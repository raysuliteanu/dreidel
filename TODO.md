...
- in the process list component, it would be nice to colorize some processes
  based on their cpu usage e.g. over 95% red, over 90% orange, over 80% yellow (or
  per the color pallete)
